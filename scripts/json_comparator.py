...
"""Compares two JSON structures from the provided text files.""",
formatter_class=argparse.RawDescriptionHelpFormatter, epilog=
"""EXAMPLE

python json_comparator.py -l gemma_extracted_info.json -r deepseek_extracted_info.json -o explanation.txt

Compare JSON structures stored in "gemma_extracted_info.json" and "deepseek_extracted_info.json" and save the explanation of the comparison into "explanation.txt".""")

params.add_argument("-l", "--left-json", type=argparse.FileType('r',encoding="utf-8"), help="The first input text file with JSON structure.")
params.add_argument("-r", "--right-json", type=argparse.FileType('r',encoding="utf-8"), help="The second input text file with JSON structure.")
...
json_l = None
try:
    json_l = json.loads(params.left_json.read())
except:
    sys.exit("The first input file contains invalid JSON. Exiting.")
json_r = None
try:
    json_r = json.loads(params.right_json.read())
except:
    sys.exit("The second input file contains invalid JSON. Exiting.")
