...
"""Reads simplified JSON from a binary file generated by "pickle" module and converts simplified JSON to universal JSON.""",
formatter_class=argparse.RawDescriptionHelpFormatter, epilog=
"""EXAMPLE

python json_converter.py -i gemma_extracted_info.bin -e example@example -n welding_gases

Read simplified JSON from \"gemma_extracted_info.bin\", convert it into universal JSON and save it into \"welding_gases.universal.json\".""")

params.add_argument("-i", "--input", type=argparse.FileType('rb'), help="The name of the input binary file generated by \"pickle\" module with a simplified JSON structure.")
...
extracted_info = pickle.loads(params.input.read())
params.input.close()
